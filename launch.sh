...
tmux send-keys -t mysession:0.1 'ros2 launch irobot_create_nav2 navigation2.launch.py serial_port:=/dev/serial/by-id/usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-if00-port0' C-m
